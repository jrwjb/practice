...
#
# #连接服务器
# ssh.connect(hostname='172.16.10.32',port=22,username='ngs',password='ngs')
#
# #执行命令
...
# transport=paramiko.Transport(('172.16.10.32',22))
# transport.connect(username='ngs',password='ngs')
...
if __name__=='__main__':
    ...
    transport=paramiko.Transport(('172.16.10.40',22))
    transport.connect(username='root',password='TopGenRoot')
    sftp=paramiko.SFTPClient.from_transport(transport)
...
if __name__=='__main__':
    ...
    host=RemoteServer('172.16.10.32','ngs','ngs')
    #从服务器上下载文件
